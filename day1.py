...
print("""I'll be using Replit, an amazing online IDE so I can do this from my phone wherever I happen to be.
No excuses for not coding from the middle of a field!""")
print("I am feeling 😍")
print("You can follow my progress at replit.com/@mspragyashahi")
